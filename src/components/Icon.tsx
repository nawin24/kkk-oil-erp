...
const P: SVGProps<SVGSVGElement> = { fill: 'none', stroke: 'currentColor', strokeWidth: 1.8, strokeLinecap: 'round', strokeLinejoin: 'round' }
...
export default function Icon({ name, size = 18, className = '', style }: {
  ...
  const body = (paths as Record<string, ReactNode>)[name] || paths.box
  return (
